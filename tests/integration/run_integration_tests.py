...
class IntegrationTestRunner:
    ...
    def __init__(self):
        self.postgres_host = os.getenv("POSTGRES_HOST", "192.168.1.104")
    ...
    def check_ollama_health(self) -> bool:
        ...
        try:
            ...
            for required_model in required_models:
                ...
                model_available = any(
                    available_model == required_model or 
                    available_model == f"{required_model}:latest" or
                    available_model.startswith(f"{required_model}:")
