...
class TestModelTags:
    ...
    def test_working_memory_tags(self):
        ...
        # Performance tags
        assert (
            "performance_critical" in tags or "rapid" in tags
        ), "Working memory should have performance tags"

        # Real-time processing tag
        assert (
            "real_time" in tags or "rapid" in tags
    ...
    def test_short_term_memory_tags(self):
        ...
        assert (
            "short_term_memory" in tags or "short_term" in tags
    ...
    def test_consolidation_tags(self):
        ...
        ), "Consolidation should have 'consolidation' orchestration tag"

        # Timing tags for biological rhythms
        assert (
            "hourly" in tags or "deep_sleep" in tags
    ...
    def test_long_term_memory_tags(self):
        ...
        assert (
            "long_term_memory" in tags or "long_term" in tags
        ...
        assert (
            "deep_sleep" in tags or "weekly" in tags
    ...
    def test_tag_consistency_across_aliases(self):
        ...
        if st_config:  # If alias exists
            ...
            assert (
                "biological" in biological_overlap
...
class TestOrchestrationTags:
    ...
    def test_short_term_processing_tags(self):
        ...
        assert any(
            "short_term" in name for name in short_term_models
        ), "Should have short-term memory models tagged appropriately"

        assert (
            len(short_term_models) >= 1
    ...
    def test_consolidation_processing_tags(self):
        ...
        assert "consolidation" in consolidation_models or any(
            "consolidation" in name for name in consolidation_models
        ), "Should have consolidation models tagged appropriately"

        assert (
            len(consolidation_models) >= 1
