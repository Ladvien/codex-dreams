...
class TestMaterializationConfigs:
    ...
    def test_materialization_strategy_documented(self):
        ...
        assert "MATERIALIZATION STRATEGY:" in content, "Materialization strategy should be documented"
        
        # Check that key stages are documented
        expected_stages = [
            "working_memory:", "short_term_memory:", "long_term_memory:", 
            "semantic:", "analytics:", "insights:", "performance:", "consolidation:"
        ]
        
        for stage in expected_stages:
            assert stage in content, f"Stage '{stage}' should be documented in materialization strategy"
