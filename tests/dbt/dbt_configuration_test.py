...
class TestDBTProjectConfiguration:
    ...
    def test_dbt_model_configuration(self):
        ...
        assert consolidation['+materialized'] == 'incremental', "Consolidation should be incremental"
    ...
    def test_directory_paths(self):
        ...
        # Test required paths
        required_paths = [
            'model-paths', 'test-paths', 'macro-paths', 
            'seed-paths', 'analysis-paths'
        ]
...
class TestDBTConnection:
    ...
    def test_dbt_profile_directory_env(self):
        ...
        if profiles_dir:
            ...
            assert default_profiles.exists() or profiles_dir, \
