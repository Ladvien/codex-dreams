...
from health_check_service import ServiceStatus, initialize_health_monitor
...
class FailureScenarioTester:
    ...
    def test_error_handler_functionality(self) -> Dict[str, Any]:
        ...
        try:
            ...
            result = error_handler.exponential_backoff_retry(
                failing_function, max_retries=5, base_delay=0.1, exceptions=(ConnectionError,)
            )
            ...
            # Verify results
            success = (
                len(error_handler.error_events) > 0
                and result == "success"
                and call_count == 3
                and "memory_percent" in resources
                and not degradation["consolidation_processing"]
            )
            ...
            return {"test": "error_handler_functionality", "status": "FAIL", "error": str(e)}
        finally:
    ...
    def test_health_monitoring(self) -> Dict[str, Any]:
        ...
        try:
            # Initialize error handler
            error_handler = BiologicalMemoryErrorHandler(
                base_path=str(test_path), circuit_breaker_enabled=True
            )
            ...
            success = (
                ...
                and "system_resources" in health_results
                and "overall_status" in summary
                and summary["overall_status"] in ["healthy", "degraded", "unhealthy", "critical"]
            )
            ...
            return {"test": "health_monitoring", "status": "FAIL", "error": str(e)}
        finally:
            self.cleanup_test_environment()
    ...
    def test_automated_recovery(self) -> Dict[str, Any]:
        ...
        try:
            ...
            success = (
                ...
                and status["dry_run"]
                and len(rules_configured) > 0
                and "postgresql" in rules_configured
                and "duckdb" in rules_configured
            )
            ...
            return {"test": "automated_recovery", "status": "FAIL", "error": str(e)}
        finally:
            self.cleanup_test_environment()
    ...
    def test_circuit_breaker_patterns(self) -> Dict[str, Any]:
        ...
        try:
            ...
            success = (
                len(circuit_breakers) > 0 and "duckdb" in circuit_breakers and circuit_breaker_test
            )
            ...
            return {
                ...
                "details": {
                    ...
                    "duckdb_cb_state": (
                        circuit_breakers.get("duckdb", {}).state
                        if "duckdb" in circuit_breakers
                        else "N/A"
                    ),
                    "ollama_cb_state": (
                        circuit_breakers.get("ollama", {}).state
                        if "ollama" in circuit_breakers
                        else "N/A"
                    ),
                },
            }
            ...
            return {"test": "circuit_breaker_patterns", "status": "FAIL", "error": str(e)}
        finally:
            self.cleanup_test_environment()
    ...
    def test_graceful_degradation(self) -> Dict[str, Any]:
        ...
        try:
            ...
            success = (
                degradation_tests["duckdb"]["consolidation_disabled"]
                and degradation_tests["ollama"]["rem_sleep_disabled"]
                and degradation_tests["postgres"]["working_memory_disabled"]
            )
            ...
            return {"test": "graceful_degradation", "status": "FAIL", "error": str(e)}
        finally:
            self.cleanup_test_environment()
    ...
    def test_dead_letter_queue(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"test": "dead_letter_queue", "status": "FAIL", "error": str(e)}
        finally:
            self.cleanup_test_environment()
    ...
    def test_orchestrator_integration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            orchestrator = BiologicalMemoryOrchestrator(base_path=str(test_path))
            ...
            if error_handler_available:
                ...
                error_summary_valid = (
                    "overall_status" in error_summary or "recovery_stats" in error_summary
                )
            else:
                error_summary_valid = False

            success = (
                error_handler_available and health_monitor_available and recovery_service_available
            )
            ...
            return {"test": "orchestrator_integration", "status": "FAIL", "error": str(e)}
        finally:
            self.cleanup_test_environment()
    ...
    def run_all_tests(self) -> Dict[str, Any]:
        ...
        for test_method in test_methods:
            try:
                ...
                failed += 1
                error_result = {"test": test_method.__name__, "status": "FAIL", "error": str(e)}
