...
class TestBiologicalMemoryOrchestrator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.orchestrator = BiologicalMemoryOrchestrator(base_path=self.temp_dir, log_dir=str(self.log_dir))
    ...
    def test_orchestrator_initialization(self):
        ...
        expected_keys = ['working_memory', 'stm', 'consolidation', 'deep_consolidation', 'rem_sleep', 'homeostasis']
        self.assertEqual(set(self.orchestrator.error_counts.keys()), set(expected_keys))
        self.assertEqual(set(self.orchestrator.performance_metrics.keys()), set(f'last_{key}' for key in expected_keys))
