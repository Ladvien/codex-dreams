...
class TestBiologicalTimingValidation(unittest.TestCase):
    ...
    def test_working_memory_5_second_intervals(self):
        ...
        self.assertGreaterEqual(len(execution_times), 2, "Should have at least 2 executions in 15 seconds")
        ...
        if intervals:
            ...
            self.assertAlmostEqual(avg_interval, 5.0, delta=1.0, 
    ...
    def test_working_memory_sleep_hours_reduced_frequency(self):
        ...
        self.assertLessEqual(len(execution_times), 1, 
                           "Should not execute frequently during sleep hours")
    ...
    def test_biological_timing_constants(self):
        ...
        self.assertIn('sleep(60)', source, "working_memory_continuous should use 60-second intervals during sleep")
    ...
    def test_timing_performance_metrics(self):
        ...
        with patch.object(self.orchestrator, 'run_dbt_command', return_value=True):
            ...
            self.assertNotEqual(
                self.orchestrator.performance_metrics['last_working_memory'], 
                initial_metric
            )
    ...
    def test_error_handling_preserves_timing(self):
        ...
        self.assertGreater(len(execution_times), 0, "Should have attempted executions despite errors")
        
        # Check that error counting is working
        self.assertGreater(self.orchestrator.error_counts['working_memory'], 0, 
...
class TestCrontabTimingValidation(unittest.TestCase):
    ...
    def test_crontab_wake_hours_specification(self):
        ...
        self.assertIn('*/1', working_memory_line, "Should run every minute to maintain 5s intervals")
    ...
    def test_biological_timing_comments(self):
        ...
        self.assertIn('5-second refresh cycles', content, 
                     "Should document 5-second working memory cycles")
        ...
        self.assertIn('biological memory', content.lower(), 
                     "Should reference biological memory processing")
