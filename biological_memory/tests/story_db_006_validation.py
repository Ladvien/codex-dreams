...
class TestStoryDB006Validation:
    ...
    def test_02_new_model_file_exists(self):
        ...
        assert "working_memory_capacity" in content, "Working memory model should reference capacity variable"
        assert "activation_strength" in content, "Working memory model should have activation_strength column"
    ...
    def test_04_all_models_reference_new_name(self):
        ...
        for model_file in expected_references:
            if model_file.exists():
                ...
                assert ("ref('wm_active_context')" in content or 
                       "ref(\"wm_active_context\")" in content), (
        ...
        for test_file in test_files:
            with open(test_file, 'r') as f:
                ...
                if "active_memories" in content and "wm_active_context" not in content:
                    ...
                    if any(keyword in content.lower() for keyword in ["create table", "from active_memories", "models/working_memory/active_memories"]):
    ...
    def test_06_readme_documentation_updated(self):
        ...
        if readme_path.exists():
            ...
            assert "wm_active_context.sql" in content, (
    ...
    def test_08_git_tracking_verification(self):
        ...
        try:
            ...
            assert any("wm_active_context.sql" in line for line in git_status.split('\n')), (
