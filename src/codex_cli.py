...
Examples:
  ...
  codex logs                 # View recent activity
    ...
    start_parser.add_argument(
        "--foreground", action="store_true", help="Run in foreground (for testing)"
    )
    ...
    config_parser.add_argument("--schedule", action="store_true", help="Quick schedule change")
    ...
    env_parser.add_argument(
        "environment", nargs="?", help="Environment to switch to (local/production)"
    )
